	...
	<div class="List_cart">
		...
		<div class="cart_table">		
			...
			<div class="tip_6">
				  ...
				  <span style="margin-left: 90px;"><a target="_blank" href="orderInfo?order_id=${order_id}">查看订单状态</a></span>&nbsp;&nbsp;<a target="_blank" href="#">查看银行限额帮助</a>
			</div>	
