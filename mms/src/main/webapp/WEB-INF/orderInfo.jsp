...
<div id="bodyPart">
  ...
  <div class="main">
	...
	<div class="order_state">
    	<div class="opr_order">
            <strong>订单号：<span id="order_id">${order_id}</span>&nbsp;&nbsp;
                状态：<span><c:if test="${empty  payMsg}">等待付款</c:if>
                            <c:if test="${not empty  payMsg}">${payMsg}</c:if></span></strong>
            <div class="state_btn">
                <ul>
                	<li><a href="alipay.jsp?order_id=${order_id}">支付</a></li>
